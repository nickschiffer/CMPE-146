...
c_bool c_list_delete(c_list_ptr p, c_list_callback delete_callback)
{
    c_list_type *list = p;
    if(!list) {
        return c_false;
...
c_bool c_list_insert_elm_end(c_list_ptr p, const void *elm_ptr)
{
    c_list_type *list = p;
    if(!list) {
        return c_false;
...
c_bool c_list_insert_elm_beg(c_list_ptr p, const void *elm_ptr)
{
    c_list_type *list = p;
    if(!list) {
        return c_false;
...
void* c_list_find_elm(c_list_ptr p, c_list_callback callback,
...
c_bool c_list_delete_elm(c_list_ptr p, const void *elm_ptr)
{
    c_list_type *list = p;
    if(!list) {
        return c_false;
...
c_bool c_list_for_each_elm(const c_list_ptr p, c_list_callback func,
                           void *arg1, void *arg2, void *arg3)
{
    const c_list_type *list = p;
...
#if 1 /* Turn to 1 to enable test code */
#include <assert.h>
#include <stdio.h>

static uint32_t del_callback_count = 0;
c_bool del_callback(void *elm_ptr, void *arg1, void *arg2, void *arg3)
{
    del_callback_count++;
    return c_true;
}

c_bool del_callback_free(void *elm_ptr, void *arg1, void *arg2, void *arg3)
{
    del_callback_count++;
    free(elm_ptr);
    return c_true;
