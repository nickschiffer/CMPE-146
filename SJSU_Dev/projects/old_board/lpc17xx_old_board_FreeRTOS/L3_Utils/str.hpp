 ...
 * This only works if you have i version of sprintf, such as siprintf().
 * If you get a compiler error, just set this to 1.
 *
...
/**
 * Easy way to declare the string on stack
 * STR_ON_STACK(my_str, 128) turns into :
 *  char __myStrBuffer[128];
 *  str my_str(__myStrBuffer, sizeof(__myStrBuffer));
 */
