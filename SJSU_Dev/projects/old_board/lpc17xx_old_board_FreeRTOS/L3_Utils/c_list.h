 ...
 * @code
 *      c_bool print_callback(void *elm_ptr, void *arg1, void *arg2, void *arg3)
 *      {
 *          printf("Value = %i\n", *(int*)elm_ptr);
 *          return c_true;
 *      }
 *      c_bool delete_callback(void *elm_ptr, void *arg1, void *arg2, void *arg3)
 *      {
 *          free(elm_ptr);
 *          return c_true;
 *      }
...
/************/
/** COMMON **/
typedef enum { c_false=0, c_true=!c_false } c_bool;
typedef c_bool (*c_list_callback)(void *elm_ptr, void *arg1, void *arg2, void *arg3);
 ...
 * @param delete_callback.  This can be NULL if you just want to free up thes
 ...
 *        the list.
 */
c_bool c_list_delete(c_list_ptr list, c_list_callback delete_callback);
 ...
 * @param elm   Pointer to your data.
 ...
 */
c_bool c_list_insert_elm_beg(c_list_ptr list, const void *elm_ptr);
c_bool c_list_insert_elm_end(c_list_ptr list, const void *elm_ptr);
/** @} */
 ...
 * When your callback returns c_false, this function will return that element back.
 * If your callback returns c_true and list iteration finishes, NULL pointer is returned.
 *
 * @param list    The list to iterate
 * @param func    The callback function.
 * @param arg1 arg2 arg3 The arguments to pass to your call-back function.
 */
void* c_list_find_elm(c_list_ptr list, c_list_callback callback,
 ...
 */
c_bool c_list_delete_elm(c_list_ptr list, const void *elm_ptr);

/**
 * Iterates your list's element(s)
 * @param list    The list to iterate
 * @param func    The callback function.  The list will iterate as long as this callback
 *                function returns c_true.  When the callback function returns c_false,
 ...
 *
 * @param arg1 arg2 arg3 The arguments to pass to your call-back function.
 * @returns c_true if entire list was iterate without your callback returning c_false
 *
 * If your list contains integers, you can use the following to check for duplicates :
 * @code
 *      static c_bool check_dup(void *elm, void *new_int, void *arg2, void *arg3)
 *      {
 ...
 * @endcode
 */
c_bool c_list_for_each_elm(const c_list_ptr list, c_list_callback func,
                           void *arg1, void *arg2, void *arg3);
