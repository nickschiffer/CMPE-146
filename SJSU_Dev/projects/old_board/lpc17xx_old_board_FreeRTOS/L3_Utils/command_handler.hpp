 ...
 */
typedef void (*CmdHandlerFuncPtr)(str& cmdParams, UartDev& output, void* pDataParam, int dataParamLen);
 ...
 * @endcode
 */
#define CMD_HANDLER_FUNC(name) void name(str& cmdParams, UartDev& output, void* pDataParam, int dataParamLen)
...
class CommandProcessor
{
    public:
         ...
         */
        bool handleCommand(str& cmd, UartDev& out);
        /** @} */
    ...
    private:
        ...
        void handleCmd(str& input, UartDev& output);

        /// Gets a list of all registered commands which is used by the "HELP" command
        void getRegisteredCommandList(UartDev& output);
         ...
         */
        void getHelpText(str& helpForCmd, UartDev& output);
