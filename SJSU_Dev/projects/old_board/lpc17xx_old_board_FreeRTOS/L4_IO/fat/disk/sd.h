...
void sd_initializeCardSignals(void); ///< Initializes the SD Card Signals using CARD_SIGNAL_INIT() and SET_CSPIN_OUT()
...
void sd_timerproc(void); 										///< Timeout function MUST BE CALLED AT 100Hz (every 10ms)
