...
class PWM
{
    public :
         ...
         * @note Frequency is only initialized the first time this class is
         *       constructed.  Once it is initialized, it cannot be set or
         *       changed when more objects are constructed.
         */
        PWM(pwmType pwm, unsigned int frequencyHz);
